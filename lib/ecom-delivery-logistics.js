...
function shipParcel(tx) {
     ...
     console.log('in shipParcel() tx.parcel.status=' + tx.parcel.status + ';');
    ...
    return getAssetRegistry('com.ecdellog.delivery.Parcel')
        .then(function (assetRegistry) {
            tx.parcel.status = 'READY_FOR_PICKUP';            
            // Update the asset in the asset registry.
            console.log('Changed status of parcel: ' + tx.parcel.$identifier + '; to ' + tx.parcel.status + '#');
